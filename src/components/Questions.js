...
// Remove this line - not needed in Next.js
// import { PATH_DASHBOARD } from '../routes/paths';
...
const mapDispatchToProps = (dispatch) => ({
    onAnswer: (payload) => dispatch({ type: ActionTypes.QuizAnswer, payload }),
    onSubmit: (payload) => {
        dispatch({ type: ActionTypes.QuizSubmit, payload });
    },
});
...
function Questions(props) {
    ...
    const setMode = async (e) => {
        ...
        // Changed this - navigate to dashboard home in Next.js
        router.push('/dashboard');
        // Or if you have a specific myapp route: router.push('/dashboard/myapp');
    };
